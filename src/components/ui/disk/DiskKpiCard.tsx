...
export type DiskKpiAccent = 'primary' | 'success' | 'warning' | 'danger' | 'info' | 'purple' | 'neutral'
...
export const DiskKpiCard: React.FC<DiskKpiCardProps> = ({
  ...
  return (
    <div
      className={`disk-kpi-card rounded-lg border border-[var(--disk-border-default,#e2e8f0)] bg-[var(--disk-bg-surface,#ffffff)] p-4 sm:p-5 shadow-xs transition-all hover:shadow-md flex flex-col justify-between ${accentConfigs.border} ${className}`}
