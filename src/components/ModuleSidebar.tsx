...
const eventMain:Item[]=[
 {key:'profile-dashboard',label:'Meu Dashboard',icon:LayoutDashboard}, {key:'events',label:'Todos os Eventos',icon:Ticket},{key:'operations',label:'Núcleo Operacional',icon:ChartNoAxesCombined},
