      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm text-xs">
          <div className="p-3.5 border-b border-slate-200 bg-slate-100 flex justify-between items-center">
            ...
            <span className="text-emerald-400 font-mono font-bold">{formatMoney(totalReceber)}</span>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm text-xs">
          <div className="p-3.5 border-b border-slate-200 bg-slate-100 flex justify-between items-center">
            ...
            <span className="text-rose-400 font-mono font-bold">{formatMoney(totalPagar)}</span>
          </div>
                  ...
                  <tr key={p.id} className="hover:bg-slate-100">
                    ...
                    <td className="py-2.5 px-2 text-center">
                      <button
                        ...
                        className="bg-emerald-950/80 hover:bg-emerald-900 text-emerald-300 text-[10px] font-bold px-2.5 py-1 rounded border border-emerald-800/40 transition"
                      >
                        Liquidar
                      </button>
                    </td>
