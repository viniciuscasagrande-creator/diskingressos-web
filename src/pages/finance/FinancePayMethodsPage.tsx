          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div className="p-3.5 bg-slate-100 rounded-xl border border-slate-200 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-500 font-semibold mb-1 text-[10px] uppercase">MDR (%)</label>
                  <input
                    type="number"
                    step="0.01"
                    value={pixMdr}
                    onChange={e => setPixMdr(e.target.value)}
                    className="w-full bg-slate-100 border border-slate-200 rounded-lg px-3 py-1.5 text-slate-900 font-mono"
                  />
                </div>
                <div>
                  <label className="block text-slate-500 font-semibold mb-1 text-[10px] uppercase">Prazo de Repasse</label>
                  <select
                    value={pixDays}
                    onChange={e => setPixDays(e.target.value)}
                    className="w-full bg-slate-100 border border-slate-200 rounded-lg px-3 py-1.5 text-slate-900"
                  >
            ...
            <div className="p-3.5 bg-slate-100 rounded-xl border border-slate-200 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-500 font-semibold mb-1 text-[10px] uppercase">Tarifa Fixa (R$)</label>
                  <input
                    type="number"
                    step="0.01"
                    value={boletoFee}
                ...
                <div>
                  <label className="block text-slate-500 font-semibold mb-1 text-[10px] uppercase">Prazo de Compensação</label>
                  <select
                    value={boletoDays}
