          ...
          <div className="space-y-3.5 pt-1">
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-slate-700 font-mono font-bold text-emerald-400">1,10% (R$ 93.940)</span>
              </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-slate-700 font-mono font-bold text-rose-400">5,20% (R$ 225.400)</span>
              </div>
              <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-slate-700 font-mono font-bold text-amber-400">2,80% (R$ 51.240)</span>
              </div>
              <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-slate-700 font-mono font-bold text-sky-400">3,10% (R$ 42.220)</span>
              </div>
              <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
          ...
          <div className="space-y-3.5 pt-1">
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-slate-700 font-mono font-bold text-sky-400">5,20%</span>
              </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-slate-700 font-mono font-bold text-sky-400">4,80%</span>
              </div>
              <div className="h-2.5 bg-slate-100 rounded-full overflow-hidden">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-slate-700 font-mono font-bold text-emerald-400">4,50% (Melhor Taxa)</span>
              </div>
              <div className="h-2.5 bg-slate-100 rounded-full overflow-hidden">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-slate-700 font-mono font-bold text-sky-400">4,20%</span>
              </div>
              <div className="h-2.5 bg-slate-100 rounded-full overflow-hidden">
