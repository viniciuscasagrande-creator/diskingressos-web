        ...
        <div className="md:col-span-5 bg-white border border-slate-200 p-5 rounded-xl space-y-4 shadow-sm text-xs">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-slate-100 border border-slate-200 rounded-lg px-3 py-2 text-slate-900 font-mono font-bold uppercase focus:outline-hidden focus:border-rose-400"
              />
              <button
          ...
          {searchResult ? (
            <div className="p-4 bg-slate-100 rounded-xl border border-slate-200 space-y-3">
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1 text-[10px] uppercase">Forma de Reembolso</label>
                <select
                  value={refundType}
              ...
              <div className="pt-2 flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 py-2 bg-rose-600 hover:bg-rose-500 text-slate-900 font-extrabold rounded-lg flex items-center justify-center gap-1.5 shadow-sm transition"
                >
            ...
            <div className="p-6 text-center text-slate-500 bg-slate-100 rounded-xl border border-slate-200">
