...
app.get('/api/health', (_req, res) => res.json({ ok: true, service: 'DiskIngressos API', phase: '16.1' }))
...
app.listen(port, () => console.log(`DiskIngressos API Fase 16.1: http://localhost:${port}/api`))
