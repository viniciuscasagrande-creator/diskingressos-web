...
supportRouter.get('/tickets',async(req:AuthedRequest,res)=>{
...
supportRouter.post('/tickets',async(req:AuthedRequest,res)=>{
...
supportRouter.patch('/tickets/:id',async(req:AuthedRequest,res)=>{
...
supportRouter.post('/tickets/:id/messages',async(req:AuthedRequest,res)=>{
...
supportRouter.get('/summary',async(req:AuthedRequest,res)=>{
...
supportRouter.get('/sla-policies',async(req:AuthedRequest,res)=>{const where=tenantWhere(req.user!,req.query.producerId);res.json(await prisma.slaPolicy.findMany({where,orderBy:{priority:'asc'}}))})
supportRouter.get('/integrations',async(req:AuthedRequest,res)=>{const where=tenantWhere(req.user!,req.query.producerId);res.json(await prisma.supportIntegration.findMany({where,orderBy:{name:'asc'}}))})
