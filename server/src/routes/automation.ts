...
automationRouter.post('/flows',requireRoles(...writeRoles),async(req:AuthRequest,res)=>{
  ...
  const row=await prisma.automationFlow.create({data:{...body,producerId,eventId:body.eventId||null} as any})
